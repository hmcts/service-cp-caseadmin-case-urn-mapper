...
GitHub Releases UI
    │
    │  1. Navigate to:
    │     https://github.com/hmcts/service-cp-caseadmin-case-urn-mapper/releases/new
...
ci-build-publish.yml
    ...
    ├── Build             service-cp-caseadmin-case-urn-mapper-1.2.6.jar
...
`https://github.com/hmcts/service-cp-caseadmin-case-urn-mapper/actions`